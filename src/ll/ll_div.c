...
#ifndef USE_ASM
void ll_div_1_limb(u64 *rd, u64 *qd, const u64 *nd, const u64 *dd, const size_t nl)
{
    return;
}

void ll_div_2_limbs(u64 *rd, u64 *qd, const u64 *nd, const u64 *dd, const size_t nl)
{
    return;
}

void ll_div_3_limbs(u64 *rd, u64 *qd, const u64 *nd, const u64 *dd, const size_t nl)
{
    return;
}

void ll_div_4_limbs(u64 *rd, u64 *qd, const u64 *nd, const u64 *dd, const size_t nl)
{
    return;
}
#endif
...
int ll_div(u64 *rd, u64 *qd, size_t *rl, size_t *ql, const u64 *nd, const u64 *dd, size_t nl, size_t dl)
{
    ...
    /* ll_div does not support divisor >= 2^256 */
    if (dl > 4 || dl == 0)
        return FP256_ERR;
    ...
    assert(nl >= dl);
    if (dl == 1)
        ll_div_1_limb(trd, tqd, nd, dd, nl);
    else {
        ...
        if (dl == 4)
            ll_div_4_limbs(trd, tqd, tnd, tdd, tnl);
        else if (dl == 3)
            ll_div_3_limbs(trd, tqd, tnd, tdd, tnl);
        else
            ll_div_2_limbs(trd, tqd, tnd, tdd, tnl);
